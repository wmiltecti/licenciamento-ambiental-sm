...
export default function PessoaJuridicaDetailsModal({
  ...
  const loadPessoaDetails = async () => {
    if (!pessoaInicial?.cnpj) {
      toast.error('CNPJ não encontrado para buscar detalhes');
      return;
    }
    ...
    try {
      ...
      toast.error('Erro ao carregar dados da pessoa jurídica');
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">Erro ao carregar dados da pessoa jurídica</p>
            </div>
          ) : (
            <>
