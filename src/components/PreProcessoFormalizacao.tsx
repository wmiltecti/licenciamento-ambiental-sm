          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-rose-800 hover:bg-rose-900 text-white rounded-lg transition-colors flex items-center gap-2"
              >
                <XCircle className="w-4 h-4" />
            ...
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-rose-800 hover:bg-rose-900 text-white text-sm rounded-lg transition-colors"
                >
                  Recusar Todos
                </button>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-2 text-slate-600 hover:bg-slate-50 rounded-lg transition-colors border border-slate-300"
                          ...
                          <button
                            ...
                            className="p-2 text-teal-700 hover:bg-teal-50 rounded-lg transition-colors border border-teal-300"
                        ...
                        <div className="mt-3">
                          <div className="flex items-start gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-2 bg-rose-800 hover:bg-rose-900 text-white text-sm rounded-lg transition-colors whitespace-nowrap"
                            >
                              Recusar
                            </button>
                          </div>
