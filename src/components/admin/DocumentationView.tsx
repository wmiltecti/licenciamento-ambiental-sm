...
export default function DocumentationView({ item, onBack }: DocumentationViewProps) {
  return (
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Documentação</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          {item.template_content && (
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <label className="text-sm font-medium text-gray-700 mb-2 block">Conteúdo do Template</label>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-blue-900 mb-1">
              Sobre os Templates de Documentação
            </h4>
            <p className="text-sm text-blue-800">
              Os templates de documentação definem modelos padronizados para os documentos
              exigidos no processo de licenciamento ambiental. Eles garantem uniformidade
              e facilitam o preenchimento das informações necessárias pelos requerentes.
            </p>
          </div>
        </div>
      </div>
