...
export default function PropertyTypeView({ item, onBack }: PropertyTypeViewProps) {
  return (
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Tipo de Imóvel</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-blue-900 mb-1">
              Sobre os Tipos de Imóvel
            </h4>
            <p className="text-sm text-blue-800">
              Os tipos de imóvel definem as diferentes categorias de propriedades que podem ser
              licenciadas. Essa classificação é importante para a correta aplicação das normas
              e procedimentos específicos de cada tipo de imóvel.
            </p>
          </div>
        </div>
      </div>
