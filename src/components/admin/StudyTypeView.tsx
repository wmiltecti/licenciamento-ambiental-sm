...
interface StudyTypeViewProps {
  item: any;
  onBack: () => void;
}

export default function StudyTypeView({ item, onBack }: StudyTypeViewProps) {
  return (
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Tipo de Estudo</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-blue-900 mb-1">
              Sobre os Tipos de Estudo
            </h4>
            <p className="text-sm text-blue-800">
              Os tipos de estudo definem as diferentes modalidades de análises ambientais que
              podem ser exigidas durante o processo de licenciamento. Cada tipo possui
              características específicas e é aplicado conforme o porte e potencial poluidor
              do empreendimento.
            </p>
          </div>
        </div>
