...
interface PollutionPotentialViewProps {
  item: any;
  onBack: () => void;
}

export default function PollutionPotentialView({ item, onBack }: PollutionPotentialViewProps) {
  return (
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Potencial Poluidor</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-blue-900 mb-1">
              Sobre os Potenciais Poluidores
            </h4>
            <p className="text-sm text-blue-800">
              Os potenciais poluidores classificam o grau de impacto ambiental que uma atividade
              pode causar. Essa classificação é fundamental para determinar as exigências e
              procedimentos de licenciamento adequados à atividade desenvolvida.
            </p>
          </div>
        </div>
      </div>
