...
/**
 * Página Documentação para Workflow Engine (Motor BPMN)
 *
 * Cópia EXATA da DocumentacaoPage.tsx original com adaptações mínimas:
 ...
 */
export default function DocumentacaoWorkflowPageMotor() {
